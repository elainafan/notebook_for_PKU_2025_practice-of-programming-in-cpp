...
void UserInfoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->getAllStarred(); break;
        case 5: _t->showMenu(); break;
        case 6: _t->changeUserName(); break;
        case 7: _t->changeUserAvatar(); break;
        case 8: _t->changeUserKey(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (UserInfoWidget::*)(const QString & )>(_a, &UserInfoWidget::userPassChanged, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (UserInfoWidget::*)()>(_a, &UserInfoWidget::getAllStarred, 4))
            return;
    }
}
...
// SIGNAL 4
void UserInfoWidget::getAllStarred()
{
