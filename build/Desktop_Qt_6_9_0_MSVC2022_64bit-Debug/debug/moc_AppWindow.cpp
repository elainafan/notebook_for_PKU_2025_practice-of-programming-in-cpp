...
template <> constexpr inline auto AppWindow::qt_create_metaobjectdata<qt_meta_tag_ZN9AppWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'buildDiaries'
        QtMocHelpers::SlotData<void(QVector<Diary>)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 7, 8 },
        }}),
        // Slot 'refresh'
...
void AppWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->buildDiaries((*reinterpret_cast< std::add_pointer_t<QList<Diary>>>(_a[1]))); break;
