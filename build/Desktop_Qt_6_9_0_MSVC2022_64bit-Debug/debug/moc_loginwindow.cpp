...
template <> constexpr inline auto LoginWindow::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'registIn'
        QtMocHelpers::SignalData<void(MyWidget *)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loggedIn((*reinterpret_cast< std::add_pointer_t<MyWidget*>>(_a[1]))); break;
        case 1: _t->registIn((*reinterpret_cast< std::add_pointer_t<MyWidget*>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginWindow::*)(MyWidget * )>(_a, &LoginWindow::loggedIn, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginWindow::*)(MyWidget * )>(_a, &LoginWindow::registIn, 1))
            return;
    }
}
...
// SIGNAL 0
void LoginWindow::loggedIn(MyWidget * _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void LoginWindow::registIn(MyWidget * _t1)
{
