...
#include "D:/notebook_for_PKU_2025_practice-of-programming-in-cpp/calendar.h"
...
void Calendar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->dateUpdated(); break;
        case 1: _t->closeWeekLine(); break;
        case 2: _t->updateWeekLine(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Calendar::*)()>(_a, &Calendar::dateUpdated, 0))
            return;
    }
}
